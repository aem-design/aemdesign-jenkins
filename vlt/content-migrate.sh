...
find $ROOT_CONTENT_FOLDER/jcr_root/content/swinburne -type f -exec \
    ...
    -e 's/cq:allowedTemplates="\[\/conf\/swinburne\//cq:allowedTemplates="\[\/conf\/swinburne-microsites\//g' \
    -e 's/redirectTarget="\/content\/swinburne\//redirectTarget="\/content\/swinburne-microsites\//g' \
    -e 's/jcr:title="Swinburne"/jcr:title="Swinburne Microsites"/g' \
    -e 's/jcr:title="Microsites Showcase Experience Fragments"/jcr:title="Swinburne Microsites Showcase Experience Fragments"/g' \
    -e 's/jcr:title="Swinburne Experience Fragments"/jcr:title="Swinburne Microsites Experience Fragments"/g' \
...
#Adding the migration for Site Experience Fragments resourceType:
find $ROOT_CONTENT_FOLDER/jcr_root/content/experience-fragments/swinburne-site -type f -exec \
    sed -i -e 's/sling:resourceType="swinburne-microsites\/components\/layout\/contentblock"/sling:resourceType="swinburne\/components\/layout\/contentblock"/g' \
    -e 's/sling:resourceType="swinburne-microsites\/components\/lists\/pagelist"/sling:resourceType="swinburne\/components\/lists\/pagelist"/g' \
    -e 's/sling:resourceType="swinburne-microsites\/components\/media\/image"/sling:resourceType="swinburne\/components\/media\/image"/g' \
    -e 's/sling:resourceType="swinburne-microsites\/components\/content\/link"/sling:resourceType="swinburne\/components\/content\/link"/g' \
    -e 's/sling:resourceType="swinburne-microsites\/components\/content\/text"/sling:resourceType="swinburne\/components\/content\/text"/g' \
    -e 's/sling:resourceType="swinburne-microsites\/components\/template\/experience-fragments\/base\/v1\/xfpage"/sling:resourceType="swinburne\/components\/template\/experience-fragments\/base\/v1\/xfpage"/g' {} +
